 ...
 * Single WhatsApp button - clean, minimal like Tattva Spa
 * Mobile & landscape friendly
 */
...
const CONFIG = {
  whatsapp: {
    number: '919876543210',
    message: 'Hi! I would like to book an appointment at Glowlogy Spa.',
  },
};
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed right-4 bottom-4 sm:right-5 sm:bottom-5 z-50 
